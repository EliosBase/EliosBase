...
const layers: Layer[] = [
  ...
  },
  {
    ...
    techs: [
      { name: "wagmi + Reown AppKit", tag: "Wallet", oneLiner: "Handles multi-wallet connection on Base.", whatItIs: "wagmi provides the chain-aware wallet client while Reown AppKit expands the connection surface to injected wallets and WalletConnect sessions.", role: "Powers wallet connect, disconnect, address state, and contract interaction hooks across MetaMask, Coinbase Wallet, Rabby, Phantom, and WalletConnect-compatible wallets.", analogy: "Like the switchboard between the browser app and whatever wallet the user actually prefers." },
