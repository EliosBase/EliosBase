      ...
      <div className="max-w-4xl mx-auto text-center">
        <AnimatedCard className="relative p-12 md:p-16 overflow-hidden glass" tilt spotlight borderGlow hoverLift={false}>
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/40 text-lg max-w-xl mx-auto mb-8">Launch with the shipped product surface: MetaMask sign-in, ETH escrow, proof-backed completion, and role-gated operations.</p>
